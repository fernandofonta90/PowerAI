...
export const USUARIOS_MOCK: UsuarioMock[] = [
  { email: "admin.otc@powerai.dev", nombre: "Admin OTC", inicial: "AO", puedeCargar: true },
  { email: "uploader.mx@powerai.dev", nombre: "Cargador MX", inicial: "MX", puedeCargar: true },
  { email: "consulta.co@powerai.dev", nombre: "Analista CO", inicial: "CO", puedeCargar: false },
  { email: "multi.torre@powerai.dev", nombre: "Multi-torre", inicial: "MT", puedeCargar: false },
];
